...
public class Perfil extends javax.swing.JFrame {
    ...
    public Perfil(String nombreUsuario) {
       ...
       initComponents();
        ...
        System.out.println(nombreUsuario);
           txtnombre.setText(control.mostrarDatos(1, nombreUsuario));
        txtapellido.setText(control.mostrarDatos(2, nombreUsuario));
        txtcorreo.setText(control.mostrarDatos(3, nombreUsuario));
        txtprograma.setText(control.mostrarDatos(4, nombreUsuario));
        txtcontraseña.setText(control.mostrarDatos(5, nombreUsuario));
        txtdocumento.setText(control.mostrarDatos(6, nombreUsuario));
    ...
    private void initComponents() {
        ...
        getContentPane().add(btnmodificar, new org.netbeans.lib.awtextra.AbsoluteConstraints(420, 410, 120, 40));
        ...
        getContentPane().add(btnSalir, new org.netbeans.lib.awtextra.AbsoluteConstraints(420, 510, 120, 40));
        ...
        getContentPane().add(jButton4, new org.netbeans.lib.awtextra.AbsoluteConstraints(420, 460, 120, 40));
